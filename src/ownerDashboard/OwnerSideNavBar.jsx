  ...
  return (
    ...
    rounded-xl hover:rounded-3xl transition-all duration-300 ease-linear cursor-pointer'
        ...
        <div className=' h-screen w-sreen overflow-scroll scrollbar-hide mt-28 mb-28'>
          ...
          />
          <p className='text-center text-sm pt-0 mb-3 font-semibold'>Dashboard</p>
          <SideBarIcon
            icon={
              <img
          ...
          />
          <p className='text-center text-sm pt-0 mb-3 font-semibold'>Lawyers</p>
          <SideBarIcon
            icon={
              <img
                alt='client icon'
          ...
          />
          <p className='text-center text-sm pt-0 mb-3 font-semibold'>Client</p>
          <SideBarIcon
            icon={
              <img
                alt='case folder icon'
          ...
          />
          <p className='text-center text-sm pt-0 mb-3 font-semibold'>Case Folder</p>
          <SideBarIcon
            icon={
              <img
                alt='timesheet icon'
          ...
          />
          <p className='text-center text-[13px] pt-0 mb-3 font-semibold'>Timesheet</p>
          <SideBarIcon
            icon={
              <img
                alt='appointment'
          ...
          />
          <p className='text-center text-[13px] pt-0 mb-3 font-semibold'>Appointment</p>
        </div>
