...
function Times({ closeShowAppointment, clients, getAppointments, appointmentList }) {
  ...
  return (
    <div className='flex rounded-md justify-center items-center flex-col  border-1 border-black shadow-lg animate-[moveTop_0.3s_ease-in-out] bg-[#e1dfdf] rounded-r h-[80%] w-[90%] lg:w-[500px] lg:h-[620px] drop-shadow-lg'>
      ...
      <form onSubmit={e => saveEvent(e, clients)} className='mt-5'>
        ...
        <div className='flex flex-col items-center mt-5 '>
          <input
            type='submit'
            value={'Submit'}
            className='bg-maroon w-[40%] text-white py-2 px-4 rounded-3xl shadow-md hover:bg-white hover:text-black active:shadow-lg transition hover:border-maroon hover:border-[1px] cursor-pointer duration-150 ease-in-out text-center'
          />
          <p
