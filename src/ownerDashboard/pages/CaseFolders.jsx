        ...
        <div className='w-[100%] h-[100%] shadow-lg bg-maroon rounded-md flex flex-col items-center lg:w-[100%] lg:h-[100%] lg:ml-20 lg:mr-2 '>
          <div className='h-[50px] flex flex-row justify-center gap-2 item-center self-end mb-2 mt-1 mr-6'>
            <button
              ...
              className='mt-2 inline-block px-6 py-2.5 bg-blue-600 text-black  text-xs leading-tight uppercase rounded-3xl shadow-md bg-white hover:bg-[#471414] font-bold hover:text-white active:shadow-lg transition duration-150 ease-in-out'
            >
              Add Folder
            </button>
            <button
            ...
            {showModal && (
              <div className='w-screen h-screen bg-modalbg absolute top-0 left-0 flex justify-center items-center'>
                <div className='flex flex-col justify-center animate-[moveTop_0.3s_ease-in-out] items-center bg-[#e1dfdf] absolute h-[55%] w-[90%] drop-shadow-lg gap-5 rounded-md md:h-[50%] md:w-[60%] lg:h-[450px] lg:w-[420px]'>
            ...
            {showUpdateFolder && (
              <div className='w-screen h-screen bg-modalbg absolute top-0 left-0 flex justify-center items-center'>
                <div className='flex w-[90%] h-[70%] pt-2 pb-2 md:w-[50%] animate-[moveTop_0.3s_ease-in-out] bg-[#D9D9D9] rounded-md lg:h-[620px] lg:w-[420px] flex-col items-center justify-evenly gap-1'>
