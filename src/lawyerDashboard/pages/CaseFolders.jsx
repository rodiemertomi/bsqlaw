              ...
              <div className='w-screen h-screen bg-modalbg absolute top-0 left-0 flex justify-center items-center'>
                <div className='flex flex-col justify-center items-center bg-[#e1dfdf] absolute h-[55%] w-[90%] drop-shadow-lg gap-5 rounded-md md:h-[50%] md:w-[60%] lg:h-[70%] lg:w-[35%] p-10'>
                  <div className='flex w-full lg:w-[60%] flex-col items-center justify-evenly mt-3 gap-5'>
                    ...
                    <button
                      className=' inline-block px-6 py-2.5 mt-1 text-white text-xs leading-tight uppercase rounded-3xl shadow-md bg-maroon hover:bg-white hover:border-[1px] hover:border-maroon w-full hover:text-black active:shadow-lg transition duration-150 ease-in-out'
                      onClick={addFolder}
                    >
                      Add Folder
                    </button>
            ...
            {showUpdateFolder && (
              <div className='w-screen h-screen bg-modalbg absolute top-0 left-0 flex justify-center items-center'>
                <div className='flex w-[90%] h-[70%] pt-2 pb-2 md:w-[50%] bg-[#D9D9D9] rounded-md lg:h-[85%] lg:w-[30%] flex-col items-center justify-evenly gap-1'>
                  ...
                  />
                  <button
                    className=' inline-block mt-1 px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded-3xl shadow-md bg-maroon w-[65%] hover:bg-white hover:text-black active:shadow-lg transition duration-150 ease-in-out hover:border-[1px] hover:border-maroon'
                    disabled={loading}
                    onClick={uploadFile}
                  >
                    Upload
