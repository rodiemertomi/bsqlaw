...
function Times({ closeShowAppointment, clients }) {
  ...
  return (
    <div className='flex rounded-md animate-[moveTop_0.3s_ease-in-out] justify-center items-center flex-col  border-1 border-black shadow-lg bg-[#e1dfdf] rounded-r h-[80%] w-[90%] lg:w-[40%] lg:h-[95%] drop-shadow-lg'>
      ...
      <form onSubmit={e => saveEvent(e, clients)} className='mt-5'>
        ...
        <div className='flex flex-col items-center mt-5 '>
          <input
            type='submit'
            value={'Submit'}
            className='bg-maroon w-[40%] cursor-pointer text-white py-2 px-4 rounded-3xl shadow-md hover:bg-white hover:text-black active:shadow-lg transition hover:border-[1px] hover:border-maroon duration-150 ease-in-out text-center'
          />
          <p
