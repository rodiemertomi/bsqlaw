            ...
            <div className='m-5 lg:m-5 text-justify'>
              <div className='flex flex-col gap-10 lg:ml-10 '>
                <details className='mt-5'>
                  <summary className='cursor-pointer'>Retainers</summary>
                  <p></p>
                </details>
                <details>
                  <summary className='cursor-pointer'>Litigagtion</summary>
                  <p></p>
                </details>
                <details>
                  <summary className='cursor-pointer'>Special Projects</summary>
                  <p></p>
                </details>
              </div>
            </div>
