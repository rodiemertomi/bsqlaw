...
function EditProfile({ closeModal }) {
  const { username, id, photoURL, firstName, lastName, contactNo, gender } = UseUserReducer()
  ...
  return (
    <div className='w-screen h-screen flex items-center justify-center bg-modalbg'>
      <div className='bg-[#e1dfdf] animate-[popUp_0.3s_ease-in-out] shadow-2xl w-[85%] h-[75%] flex flex-col items-center justify-center rounded-lg md:h-[95%] lg:h-[90%] lg:w-[40%] lg:gap-3'>
