    ...
    try {
      ...
      switch (error.code) {
        case "auth/email-already-in-use":
          setError(
            `Email address ${signUpEmailRef.current.value} already in use.`
          );
          break;
        ...
        {showLogin && (
          <div className="flex justify-center flex-col w-[270px] h-[500px]">
            ...
            <form
              ...
              className="flex flex-col mt-4 gap-2 w-[270px] h-[290px]"
            >
              ...
              <label
                htmlFor="password"
                className="font-Lora mt-3 font-semibold"
              >
                PASSWORD:
              </label>
              <input
        ...
        {showSignUp && (
          <div className="flex flex-col w-[270px] h-full ">
            ...
            >
              ...
              <label
                htmlFor="username"
                className="mt-3 text-sm font-Lora font-semibold"
              >
                USERNAME:
              </label>
              <input
