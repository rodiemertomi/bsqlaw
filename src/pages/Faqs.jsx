    ...
    <div className='min-h-screen flex flex-col content-center  bg-white p-6 font-Lora'>
      <div className='md:w-[550px] font-Lora  md:flex md:flex-col md:self-center lg:flex lg:flex-row lg:gap-10 lg:w-[900px] lg:mt-14 lg:ml-32 '>
        <div className='mt-16 flex flex-col gap-5 lg:mt-5 animate-[moveTop_0.8s_ease-in-out]'>
          ...
          <p className='text-[#8C760A] font-bold lg:ml-10'>
          ...
          <details className='text-justify lg:ml-10'>
            ...
            <p className='text-justify xl:mr-52 text-[#8C760A]'>
              ...
              significant savings. On the other hand, when you are, in fact, suing or being sued,
              legal representation is indispensable and urgent.
            </p>
          </details>
          <details className='text-justify lg:ml-10'>
            <summary className='font-semibold cursor-pointer '>
            ...
            <p className='text-justify xl:mr-52 text-[#8C760A]'>
              ...
              problems or when legal exposure in terms of money increase, it may be wise to consider
              such factors as educational background and attainment, length of period in the
              practice, specialization, manpower and other resources, and pedigree in hiring legal
              representation.
            </p>
          </details>
          <details className='text-justify lg:ml-10'>
            ...
            <p className='text-justify xl:mr-52 text-[#8C760A]'>
              ...
              preferred and sought after as they employ their significant advantage in education,
              expertise, experience and established networks in servicing their clients.
            </p>
          </details>
          <details className='text-justify lg:ml-10'>
            <summary className='font-semibold cursor-pointer'>
            ...
            <p className='text-justify xl:mr-52 text-[#8C760A]'>
              ...
              familiarity with the business and its unique concerns, rapport, consistency of quality
              of service, and value for money. Thus, while a multi-specialty firm is a
              jack-of-all-trades, it is also a master of several fields because of the
              specialization of its lawyers.
            </p>
          </details>
          <details className='text-justify lg:ml-10'>
            <summary className='font-semibold cursor-pointer'>
            ...
            <p className='text-justify xl:mr-52 text-[#8C760A]'>
              ...
              top-notch services, exceptional lawyers and good law firms, knowing the value of their
              services, are able to put a reasonable premium on their fees in exchange for better
              quality of service, speed and efficiency.
            </p>
          </details>
          <details className='text-justify lg:ml-10'>
            <summary className='font-semibold cursor-pointer'>
            ...
            <p className='text-justify xl:mr-52 text-[#8C760A]'>
              ...
              exposure for the client, the client’s stature, who referred the client, and whether
              the client is an old or new client. These factors also determine the discounts on fees
              lawyers may afford their preferred clients.
            </p>
          </details>
          <details className='text-justify lg:ml-10'>
            <summary className='font-semibold cursor-pointer'>
            ...
            <p className='text-justify xl:mr-52 text-[#8C760A]'>
              ...
              packaged or stage-billing; (e) hourly-capped; (f) contingency or success; or a
              combination of said fee structures.
            </p>
          </details>
          <details className='text-justify lg:ml-10'>
            ...
            <p className='text-justify xl:mr-52 text-[#8C760A]'>
              ...
              the lawyer or law firm and the assurance that the lawyer or law firm shall not engage
              other clients or espouse other interests that are in conflict with the client’s.
            </p>
          </details>
          <details className='text-justify lg:ml-10'>
            ...
            <p className='text-justify xl:mr-52 text-[#8C760A]'>
              ...
              housekeeping and corporate secretary services may also be included in such fee. A
              retainer fee does not usually include prosecuting or defending against criminal, civil
              or administrative cases, or those before quasi-judicial agencies (such as the
              Department of Justice and the NLRC), which are billed hourly.
            </p>
          </details>
          <details className='text-justify lg:ml-10'>
            <summary className='font-semibold cursor-pointer'>
            ...
            <p className='text-justify xl:mr-52 text-[#8C760A]'>
              ...
              opinions, preparation of voluminous documents or submissions requiring considerable
              amounts of time, manpower or effort may also be billed by the hour. The hourly-billing
              arrangement is the customary fee structure employed by lawyers because it is generally
              regarded as the most fair for both the lawyer and the client. This is because the
              amount of fees is directly proportional to the amount of work performed as it is based
          ...
          <details className='text-justify lg:ml-10'>
            ...
            <p className='text-justify xl:mr-52 text-[#8C760A]'>
              ...
              the money value of the legal claim prosecuted or defended against, in which case, it
              is sometimes referred to as “value-billing”.
            </p>
          </details>
          <details className='text-justify lg:ml-10'>
            <summary className='font-semibold cursor-pointer'>
          ...
          <details className='text-justify lg:ml-10'>
            ...
            <p className='text-justify xl:mr-52 text-[#8C760A]'>
              ...
              contingency fees are not popular among reputable lawyers as it places a pecuniary
              interest in the outcome of the case and encourages a mercenary attitude among lawyers.
              A success fee is a variation of the contingency fee in that while a lawyer may be
              compensated by the hour or per output, he or she is entitled to collect a fixed fee in
              case of a victory.
            </p>
          </details>
          <details className='text-justify lg:ml-10'>
          ...
          <details className='text-justify lg:ml-10'>
            ...
            <p className='text-justify xl:mr-52 text-[#8C760A]'>
              ...
              like, are for the client’s account. Lawyers usually ask for a deposit for
              out-of-pocket expenses to defray these costs. These costs are not fees for
              professional services; rather, they are costs arising from engaging in legal
              processes.
            </p>
          </details>
        </div>
